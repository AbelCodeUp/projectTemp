...
// import ReactSwipe from '../js/reactSwipe';
...
// const numberOfSlides = parseInt(query.slidesNum, 1) || 2;
// const paneNodes = Array.apply({}, Array(numberOfSlides)).map((_, i) => {
//     return (
//         <div key={i}>
...
export default class MyAppointmentTY1 extends React.Component {
    ...
    render() {
        ...
        if (dataObj == null || dataObj.length == 0 || !dataObj) {
            items.push(
                <div className="remindbox" key={1} style={{ paddingTop: '2.2rem' }}>
